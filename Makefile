...
#    Updated: 2019/05/01 19:02:21 by sbearded         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
COMP = 			gcc -g $(WFLAGS) -I $(INC) -I $(LIB_HEAD) -c -o
...
$(NAME):		do_libft $(OBJ)
				@gcc -g $(WFLAGS) $(MS_OBJ_PATH) $(PR_OBJ_PATH) $(WK_OBJ_PATH) $(FR_OBJ_PATH) $(MC_OBJ_PATH)\
				$(LIBFT) \
